...
class ImportKillerCrossover2026 < ActiveRecord::Migration[7.2]
  ...
  def up
    Edition.import('results/killer_crossover_2026.csv', 'Killer Crossover', 2026, '2026-08-07', '2026-08-09', 2)
  end
