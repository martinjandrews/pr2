...
module Api
  module V1
    class RankingsControllerTest < ActionDispatch::IntegrationTest
      ...
      test "includes previous_rank and previous_total only for players whose rank changed" do
        ...
        # pushing bob, carol and dave down a spot; alice is unaffected.
        ...
        assert_nil alice["previous_total"]
